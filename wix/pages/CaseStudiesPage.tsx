...
import type { CaseStudies } from "@/entities"
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          <div className="font-heading text-xl sm:text-2xl lg:text-3xl font-black text-black">
        ...
        <div className="max-w-[120rem] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20 gap-4">
            ...
            <div className="hidden lg:flex items-center space-x-6 xl:space-x-8">
              <Link href="/case-studies-page" className="font-paragraph text-base text-primary font-semibold">
                Case Studies
              </Link>
        ...
        <div className="max-w-[120rem] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="font-paragraph text-lg sm:text-xl text-black/80 leading-relaxed">
              Real results from real clients who trusted us to grow their business. Discover how our proven strategies
        ...
        <div className="max-w-[120rem] mx-auto px-4 sm:px-6 lg:px-8">
          {caseStudies.length === 0 ? (
            <div className="text-center py-12 sm:py-16 lg:py-20">
              <p className="font-paragraph text-lg text-black/80">No case studies available at the moment.</p>
            </div>
          ) : (
                  ...
                  <div className="bg-white border border-gray-100 rounded-2xl sm:rounded-3xl overflow-hidden hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="aspect-video bg-gray-50 flex items-center justify-center">
                      <Image
                        src={
                          ...
                          "https://static.wixstatic.com/media/204237_c9494b0e9e44400286b8874144f58fe5~mv2.png?originWidth=576&originHeight=320" ||
                          "/placeholder.svg"
                        }
                    ...
                    <div className="p-6 sm:p-8 lg:p-12">
                      ...
                      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                        <Button
                          asChild
                          className="bg-primary text-white hover:bg-primary-hover px-4 sm:px-6 py-2 sm:py-3 font-semibold rounded-full text-sm sm:text-base"
                        >
                          <Link href="/contact-page">Get Similar Results</Link>
                        </Button>
                        ...
                        {study.projectUrl && (
                          <Button
                            asChild
                            variant="outline"
                            className="border-2 border-black text-black hover:bg-black hover:text-white px-4 sm:px-6 py-2 sm:py-3 font-semibold rounded-full text-sm sm:text-base bg-transparent"
                          >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            {[
              ...
              >
                ...
                <div className="font-paragraph text-xs sm:text-sm text-black/70">{stat.description}</div>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-[120rem] mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              ...
              >
                <Link href="/contact-page">Start Your Success Story</Link>
              </Button>
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-2 border-white text-white hover:bg-white hover:text-primary px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-full bg-transparent"
              >
                <Link href="/case-studies-page">Explore More Case Studies</Link>
              </Button>
            </div>
          </motion.div>
        </div>
