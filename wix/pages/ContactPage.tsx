    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        ...
        >
          ...
          <h1 className="font-heading text-3xl font-bold text-primary mb-4">Thank You!</h1>
        ...
        <div className="max-w-[120rem] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20 gap-4">
            ...
            <div className="hidden lg:flex items-center space-x-6 xl:space-x-8">
              ...
              <Link href="/contact" className="font-paragraph text-base text-primary font-semibold">
                Contact
              </Link>
            </div>
        ...
        <div className="max-w-[120rem] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="font-paragraph text-lg sm:text-xl text-black/70 leading-relaxed">
              Ready to accelerate your business growth? Let's discuss how our proven strategies can transform your
              marketing performance and drive measurable results.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            >
              <div>
                ...
                <p className="font-paragraph text-base sm:text-lg text-black/70 leading-relaxed">
                  Whether you're looking to scale your existing marketing efforts or starting from scratch, we're here
                  to help. Get in touch for a free consultation and discover how we can accelerate your business growth.
                </p>
              </div>
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-paragraph text-xs sm:text-sm text-black/60">Monday - Friday, 9AM - 6PM IST</p>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 rounded-xl sm:rounded-2xl p-6 sm:p-8">
                <h3 className="font-heading text-lg sm:text-xl font-bold text-black mb-3 sm:mb-4">What to Expect</h3>
            ...
            >
              <div className="bg-white border border-gray-100 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-6">
                  ...
                  <div>
                    <label className="block font-heading text-sm font-bold text-black mb-2">Full Name *</label>
                  ...
                  <div>
                    <label className="block font-heading text-sm font-bold text-black mb-2">Email Address *</label>
                  ...
                  <div className="grid md:grid-cols-2 gap-3 sm:gap-4">
                    <div>
                      <label className="block font-heading text-sm font-bold text-black mb-2">Company</label>
                    ...
                    <div>
                      <label className="block font-heading text-sm font-bold text-black mb-2">Phone</label>
                  ...
                  <div>
                    <label className="block font-heading text-sm font-bold text-black mb-2">Service Interest *</label>
                  ...
                  <div>
                    <label className="block font-heading text-sm font-bold text-black mb-2">Monthly Budget *</label>
                  ...
                  <div>
                    <label className="block font-heading text-sm font-bold text-black mb-2">Message *</label>
        ...
        <div className="max-w-[120rem] mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="bg-white text-primary border-white hover:bg-gray-100 px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-full"
            >
